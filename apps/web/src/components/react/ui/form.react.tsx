...
export const Badge = ({ className, children, ...props }: any) => {
  return (
    <div
      className={`inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-gray-950 focus:ring-offset-2 bg-gray-100 text-gray-900 hover:bg-gray-100/80 ${className}`}
      {...props}
    >
      {children}
    </div>
